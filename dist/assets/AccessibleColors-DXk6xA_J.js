...
<circle
  ...
  stroke="none"
/>
`}},wo=()=>{var Io;const t=O*20,c=t,u=c/3,o=u/1.5,v=t/4,N=u/20,y=c/10,x=((Io=s[D])==null?void 0:Io.items)||[],T=(x==null?void 0:x.length)*(u+o)-o+v*2,Z=l?y+v:0,mo=x.length*c,Ao=T+Z*1.6,Qo=x==null?void 0:x.map((U,oo)=>{const eo=oo*c;let K;try{K=Y(U.color,U.colorFormat)}catch(J){console.error(J),m(ho(`${Mo[n]}: ${J.message}`,!0,4)),K="#000000"}const uo=`
        <rect
          x="${eo}"
          y="0"
          width="${c}"
