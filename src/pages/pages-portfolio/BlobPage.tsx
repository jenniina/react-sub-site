...
export default function BlobPage({ heading, text, type }: { heading: string; text: string; type: string }) {
                        ...
                        <div>
                            <div className="medium">
                                ...
                                <ul className='ul'>
                                    ...
                                    <li>Sliders to control background
                                        <ul>
                                            <li>Lightness</li>
                                            <li>Saturation</li>
                                            <li>Hue</li>
                                ...
                                <h4>Pointer Use</h4>
                                <ul className='ul'>
                                    <li>Change blob color by dragging to a color node on the right hand side</li>
                                    <li>Change blob size by dragging it to one of the corners on the right hand side</li>
                                    <li>Change blob size by scrolling with the mouse wheel (note: you may want to disable scrolling first with the button on the top right)</li>
                                ...
                                <h4>Keyboard Use</h4>
                                <ul className='ul'>
                                    <li>Tab to a blob, and with it in focus:
                                        <ul>
