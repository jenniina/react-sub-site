export enum ERemoveTaskEitherIndividuallyOrClearAllCompletedTasksAtOnce {
...
export enum EShowsHowManyTasksAreLeftToDo {
...
export enum EStoresTasksInMongoDBIfTheUserIsLoggedIn {
...
export enum EAddTasksByTabbingToTheInputFieldAnd {
...
//Remove a task by tabbing to the remove-button and pressing Space, or remove all completed tasks by pressing Space on the Clear Completed Tasks button
