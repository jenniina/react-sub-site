...
export const translations = {
  ...
  WithPurpleWrittenLast: {
    en: 'with hsl(300,100%,33%) written last, without spaces in the color',
    es: 'con hsl(300,100%,33%) escrito al final, sin espacios en el color',
    fr: 'avec hsl(300,100%,33%) écrit en dernier, sans espaces dans la couleur',
    de: 'mit hsl(300,100%,33%) zuletzt geschrieben, ohne Leerzeichen in der Farbe',
    pt: 'com hsl(300,100%,33%) escrito por último, sem espaços na cor',
