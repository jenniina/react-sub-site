...
export const translations = {
  ...
  TheFollowingAppliesToLoggingInAndStoringUserInfo: {
    en: 'This Privacy Policy explains how I (Jenniina Laine) collect, use, and protect your personal information.',
    es: 'Esta Política de Privacidad explica cómo yo (Jenniina Laine) recopilo, uso y protejo su información personal.',
    fr: 'Cette politique de confidentialité explique comment je (Jenniina Laine) collecte, utilise et protège vos informations personnelles.',
    de: 'Diese Datenschutzrichtlinie erklärt, wie ich (Jenniina Laine) Ihre persönlichen Daten sammle, verwende und schütze.',
    pt: 'Esta Política de Privacidade explica como eu (Jenniina Laine) coleto, uso e protejo suas informações pessoais.',
    cs: 'Toto prohlášení o ochraně osobních údajů vysvětluje, jak shromažďuji, používám a chráním vaše osobní údaje.',
    fi: 'Tämä tietosuojakäytäntö selittää, miten minä (Jenniina Laine) kerään, käytän ja suojaan henkilötietojasi.',
  },
  TheDataController: {
  ...
  RadiatingConcentricRingsThat: {
    en: 'Radiating concentric rings that expand in a loop, shedding tiny particles in an arc, eventually shrinking into nothing',
    es: 'Anillos concéntricos radiantes que se expanden en un bucle, desprendiendo pequeñas partículas en un arco, eventualmente encogiéndose hasta desaparecer',
    fr: 'Des anneaux concentriques rayonnants qui s étendent en boucle, libérant de minuscules particules en arc, rétrécissant finalement jusqu à disparaître',
  ...
  SquaresStandingOnTheirCorner: {
    en: 'Radiating squares standing on their corner',
    es: 'Cuadrados radiantes de pie en su esquina',
    fr: 'Des carrés rayonnants debout sur leur coin',
    de: 'Strahlende Quadrate, die auf ihrer Ecke stehen',
    pt: 'Quadrados radiantes em pé em seu canto',
    cs: 'Zářící čtverce stojící na svém rohu',
    fi: 'Säteilevät neliöt seisovat kulmallaan',
  },
  GraphQLSite: {
    en: 'GraphQL site',
    es: 'Sitio de GraphQL',
  ...
  SupportsLayers: {
    en: 'Supports layers',
    es: 'Soporta capas',
    fr: 'Prend en charge les calques',
    de: 'Unterstützt Ebenen',
    pt: 'Suporta camadas',
    cs: 'Podporuje vrstvy',
    fi: 'Käyttää tasoja',
  },
  ...
  SaveOrDownloadArt: {
    en: 'Save or download art',
    es: 'Guardar o descargar arte',
    fr: "Enregistrer ou télécharger l'art",
    de: 'Kunst speichern oder herunterladen',
    pt: 'Salvar ou baixar arte',
  ...
  QuizQuestions15AreFetchedFrom: {
    en: 'Quiz questions (20) are fetched from',
    es: 'Las preguntas del cuestionario (20) se obtienen de',
    fr: 'Les questions du quiz (20) sont récupérées à partir de',
    de: 'Quizfragen (20) werden von',
    pt: 'As perguntas do quiz (20) são buscadas em',
    cs: 'Otázky kvízu (20) jsou načteny z',
    fi: 'Kyselykysymykset (20) haetaan',
  },
  ...
  TestYourGeneralKnowledgeWithThese15Questions: {
    en: 'Test your general knowledge with these 20 questions (in English)',
    es: 'Pon a prueba tus conocimientos generales con estas 20 preguntas (en inglés)',
    fr: 'Testez vos connaissances générales avec ces 20 questions (en anglais)',
    de: 'Testen Sie Ihr Allgemeinwissen mit diesen 20 Fragen (auf Englisch)',
    pt: 'Teste seus conhecimentos gerais com estas 20 perguntas (em inglês)',
    cs: 'Otestujte své všeobecné znalosti pomocí těchto 20 otázek (v angličtině)',
    fi: 'Testaa yleistä tietämystäsi näillä 20 kysymyksellä (englanniksi)',
  },
  ChooseDifficulty: {
  ...
  PayFor10HoursGet11: {
    en: 'For every ten hours of work that you pay for at once, you will get one extra hour of work.',
    es: 'Por cada diez horas de trabajo que pague de una vez, obtendrá una hora extra de trabajo.',
    fr: "Pour chaque tranche de dix heures de travail payée d'un coup, vous obtenez une heure de travail supplémentaire.",
    de: 'Für jeweils zehn Arbeitsstunden, die Sie auf einmal bezahlen, erhalten Sie eine zusätzliche Arbeitsstunde.',
    pt: 'Para cada dez horas de trabalho pagas de uma só vez, você recebe uma hora extra de trabalho.',
    cs: 'Za každých deset hodin práce zaplacených najednou získáte jednu hodinu práce navíc.',
    fi: 'Jokaista kerralla maksettua kymmentä työtuntia kohden saat yhden ylimääräisen työtunnin.',
  },
  HourlyWorkCanBeUsed: {
  ...
  FreeHourUnlocked: {
    en: 'Bonus unlocked!',
    es: 'Bonificación desbloqueada!',
    fr: 'Bonus débloqué!',
    de: 'Bonus freigeschaltet!',
    pt: 'Bônus desbloqueado!',
    cs: 'Bonus odemčen!',
    fi: 'Bonus avattu!',
  },
  ReferenceForInvoice: {
  ...
  UsesThreeDifferentAPI: {
    en: 'Uses three different API',
    es: 'Utiliza tres API diferentes',
    fr: 'Utilise trois API différentes',
    de: 'Verwendet drei verschiedene APIs',
  ...
  DraggableWithAPointer: {
    en: 'Draggable with a pointer',
    es: 'Arrastrable con un puntero',
    fr: 'Déplaçable avec un pointeur',
    de: 'Mit einem Zeiger ziehbar',
    pt: 'Arrastável com um ponteiro',
    cs: 'Přetahovatelné pomocí ukazatele',
    fi: 'Raahattavissa osoittimen kanssa',
  },
  ...
  ColorTheDraggableCardsAndContainersAndSortThem: {
    en: 'Color the draggable cards and containers and sort them as you wish',
    es: 'Colorea las tarjetas y contenedores arrastrables y ordénalos como desees',
    fr: 'Coloriez les cartes et les conteneurs déplaçables et triez-les comme vous le souhaitez',
    de: 'Färben Sie die ziehbaren Karten und Container und sortieren Sie sie nach Belieben',
    pt: 'Colore os cartões e contêineres arrastáveis e classifique-os como desejar',
    cs: 'Obarvěte přetahovatelné karty a kontejnery a seřaďte je podle svých představ',
    fi: 'Värjää raahattavat kortit ja säiliöt ja lajittele ne haluamallasi tavalla',
  },
  ...
  AddTextOrColor: {
    en: 'Add a text/color',
    es: 'Agregar un texto/color',
    fr: 'Ajouter un texte/couleur',
    de: 'Fügen Sie einen Text/Farbe hinzu',
    pt: 'Adicionar um texto/cor',
    cs: 'Přidat text/barvu',
    fi: 'Lisää teksti/väri',
  },
  ...
  AlsoWorksWithHexColors: {
    en: 'Also works with HEX colors, ie. #fff or #123abc or RGB or HSL values',
    es: 'También funciona con colores HEX, es decir, #fff o #123abc o valores RGB o HSL',
    fr: 'Fonctionne également avec les couleurs HEX, c est-à-dire #fff ou #123abc ou les valeurs RGB ou HSL',
    de: 'Funktioniert auch mit HEX-Farben, z.B. #fff oder #123abc oder RGB- oder HSL-Werten',
    pt: 'Também funciona com cores HEX, ou seja, #fff ou #123abc ou valores RGB ou HSL',
    cs: 'Funguje také s HEX barvami, tj. #fff nebo #123abc nebo RGB nebo HSL hodnotami',
    fi: 'Toimii myös HEX-värien kanssa, esim. #fff tai #123abc tai RGB- tai HSL-arvot',
  },
  EditText: {
    en: 'Edit text',
    es: 'Editar texto',
  ...
  InvalidColor: {
    en: 'Invalid color',
    es: 'Color no válido',
    fr: 'Couleur non valide',
    de: 'Ungültige Farbe',
    pt: 'Cor inválida',
    cs: 'Neplatná barva',
    fi: 'Virheellinen väri',
  },
  TipIfYouAddAGenericWordYouCanColorTheCard: {
    en: 'Tip: if you add a generic word, you can color the card by writing a color name last, e.g. "apple pink" or apple rgb(218,112,214) with no spaces in the color. This will result in a pink card with "apple" written on it.',
    es: 'Consejo: si agrega una palabra genérica, puede colorear la tarjeta escribiendo un nombre de color al final, por ejemplo, "manzana pink" o manzana rgb(218,112,214) sin espacios en el color. Esto resultará en una tarjeta rosa con "manzana" escrita en ella.',
    fr: 'Astuce: si vous ajoutez un mot générique, vous pouvez colorer la carte en écrivant un nom de couleur à la fin, par exemple "pomme pink" ou pomme rgb(218,112,214) sans espaces dans la couleur. Cela donnera une carte rose avec "pomme" écrit dessus.',
    de: 'Tipp: Wenn Sie ein generisches Wort hinzufügen, können Sie die Karte einfärben, indem Sie am Ende einen Farbnamen schreiben, z.B. "Apfel pink" oder Apfel rgb(218,112,214) ohne Leerzeichen in der Farbe. Das ergibt eine rosa Karte mit "Apfel" darauf geschrieben.',
    pt: 'Dica: se você adicionar uma palavra genérica, pode colorir o cartão escrevendo um nome de cor por último, por exemplo, "maçã pink" ou maçã rgb(218,112,214) sem espaços na cor. Isso resultará em um cartão rosa com "maçã" escrito nele.',
    cs: 'Tip: pokud přidáte obecné slovo, můžete kartu obarvit napsáním názvu barvy na konec, např. "jablko pink" nebo jablko rgb(218,112,214) bez mezer ve barvě. To způsobí růžovou kartu s napsaným "jablko".',
    fi: 'Vinkki: jos lisäät yleisen sanan, voit värittää kortin kirjoittamalla värinimen viimeiseksi, esim. "omena pink" tai omena rgb(218,112,214) ilman välilyöntejä värissä. Tämä johtaa vaaleanpunaiseen korttiin, jossa lukee "omena".',
  },
  Tip: {
    en: 'Tip',
    es: 'Consejo',
  ...
  YouMayEditTheBackgroundColorBy: {
    en: 'You may edit the background color of a single container through the menu on the container header.',
    es: 'Puede editar el color de fondo de un solo contenedor a través del menú en el encabezado del contenedor.',
    fr: 'Vous pouvez modifier la couleur de fond d un seul conteneur via le menu de l en-tête du conteneur.',
    de: 'Sie können die Hintergrundfarbe eines einzelnen Containers über das Menü in der Containerüberschrift bearbeiten.',
    pt: 'Você pode editar a cor de fundo de um único contêiner através do menu no cabeçalho do contêiner.',
    cs: 'Barvu pozadí jednoho kontejneru můžete upravit pomocí nabídky v záhlaví kontejneru.',
    fi: 'Voit muokata yksittäisen säiliön taustaväriä säiliön otsikon valikosta.',
  },
  YouMayEditTheColorLater: {
    en: 'You may edit the color and text later from the dropdown menu on the card by clicking the drag handle.',
    es: 'Puede editar el color y el texto más tarde desde el menú desplegable en la tarjeta haciendo clic en el controlador de arrastre.',
    fr: 'Vous pouvez modifier la couleur et le texte plus tard à partir du menu déroulant sur la carte en cliquant sur la poignée de glissement.',
    de: 'Sie können die Farbe und den Text später über das Dropdown-Menü auf der Karte bearbeiten, indem Sie auf den Ziehgriff klicken.',
    pt: 'Você pode editar a cor e o texto mais tarde no menu suspenso no cartão clicando na alça de arrastar.',
    cs: 'Barvu a text můžete později upravit z rozbalovací nabídky na kartě kliknutím na úchyt pro přetahování.',
    fi: 'Voit muokata väriä ja tekstiä myöhemmin kortin avattavasta valikosta napsauttamalla raahauskahvaa.',
  },
  ...
  WithHSLWrittenLast: {
    en: 'with hsl(50,50%,50%) written last, without spaces in the color',
    es: 'con hsl(50,50%,50%) escrito al final, sin espacios en el color',
    fr: 'avec hsl(50,50%,50%) écrit en dernier, sans espaces dans la couleur',
    de: 'mit hsl(50,50%,50%) zuletzt geschrieben, ohne Leerzeichen in der Farbe',
    pt: 'com hsl(50,50%,50%) escrito por último, sem espaços na cor',
    cs: 's hsl(50,50%,50%) napsáno na konci, bez mezer ve barvě',
    fi: 'hsl(50,50%,50%) kirjoitettu viimeiseksi ilman välilyöntejä värissä',
  },
  WithKhakiWrittenLast: {
    en: 'with khaki written last',
    es: 'con khaki escrito al final',
    fr: 'avec khaki écrit en dernier',
    de: 'mit khaki zuletzt geschrieben',
    pt: 'com khaki escrito por último',
    cs: 's khaki napsáno na konci',
    fi: 'khaki kirjoitettu viimeiseksi',
  },
  ...
  ResetBackgroundColors: {
    en: 'Reset background colors',
    es: 'Restablecer colores de fondo',
    fr: 'Réinitialiser les couleurs de fond',
    de: 'Hintergrundfarben zurücksetzen',
    pt: 'Redefinir cores de fundo',
    cs: 'Obnovit barvy pozadí',
    fi: 'Nollaa taustavärit',
  },
  SetCustomBackgroundColors: {
    en: 'Set custom background colors',
    es: 'Establecer colores de fondo personalizados',
    fr: 'Définir des couleurs de fond personnalisées',
    de: 'Benutzerdefinierte Hintergrundfarben festlegen',
    pt: 'Definir cores de fundo personalizadas',
    cs: 'Nastavit vlastní barvy pozadí',
    fi: 'Aseta mukautetut taustavärit',
  },
  TitleBackground: {
    en: 'Title background',
    es: 'Fondo del título',
    fr: 'Arrière-plan du titre',
    de: 'Titelhintergrund',
    pt: 'Fundo do título',
    cs: 'Pozadí názvu',
    fi: 'Otsikon tausta',
  ...
  MusicNotesPlacedWithinAStaff: {
    en: 'Music notes placed within a staff',
    es: 'Notas musicales colocadas dentro de un pentagrama',
    fr: 'Notes de musique placées sur une portée',
    de: 'Musiknoten, die auf einem Notensystem platziert sind',
    pt: 'Notas musicais colocadas em uma pauta',
    cs: 'Hudební noty umístěné na notové osnově',
    fi: 'Nuotteja sijoitettuina nuottiviivastolle',
  },
  ComposerPage: {
    en: 'Composer Page',
  ...
  ColorConstellation: {
    en: 'Color constellation',
    es: 'Constelación de colores',
    fr: 'Constellation de couleurs',
    de: 'Farbkonstellation',
    pt: 'Constelação de cores',
    cs: 'Barevná konstelace',
    fi: 'Värikonstellaatio',
  },
  DraggableColors: {
    en: 'draggable colors',
    es: 'colores arrastrables',
    fr: 'couleurs déplaçables',
    de: 'verschiebbare Farben',
    pt: 'cores arrastáveis',
    cs: 'přetahovatelné barvy',
    fi: 'siirrettävät värit',
  },
  CurrentThreshold: {
    en: 'Current threshold',
    es: 'Umbral actual',
    fr: 'Seuil actuel',
    de: 'Aktueller Schwellenwert',
    pt: 'Limite atual',
    cs: 'Aktuální práh',
    fi: 'Nykyinen kynnys',
  },
  FocusOrPinAColorToHearItsContrastMatches: {
    en: 'Focus or pin a color to hear its contrast matches.',
    es: 'Enfoque o fije un color para escuchar sus coincidencias de contraste.',
    fr: 'Placez le focus sur une couleur ou épinglez-la pour entendre ses correspondances de contraste.',
    de: 'Fokussieren oder fixieren Sie eine Farbe, um ihre Kontrasttreffer zu hören.',
    pt: 'Foque ou fixe uma cor para ouvir suas correspondências de contraste.',
    cs: 'Zaměřte nebo připněte barvu, abyste slyšeli její kontrastní shody.',
    fi: 'Kohdista väriin tai kiinnitä se kuullaksesi sen kontrastiosumat.',
  },
  NoVisibleMatchesAtTheCurrentThreshold: {
    en: 'No visible matches at the current threshold',
    es: 'No hay coincidencias visibles en el umbral actual',
    fr: 'Aucune correspondance visible au seuil actuel',
    de: 'Keine sichtbaren Treffer beim aktuellen Schwellenwert',
    pt: 'Nenhuma correspondência visível no limite atual',
    cs: 'Při aktuálním prahu nejsou viditelné žádné shody',
    fi: 'Nykyisellä kynnyksellä ei ole näkyviä osumia',
  },
  VisibleMatches: {
    en: 'visible matches',
    es: 'coincidencias visibles',
    fr: 'correspondances visibles',
    de: 'sichtbare Treffer',
    pt: 'correspondências visíveis',
    cs: 'viditelné shody',
    fi: 'näkyvät osumat',
  },
  ConnectedToActiveColorWith: {
    en: 'Connected to active color with',
    es: 'Conectado al color activo con',
    fr: 'Connecté à la couleur active avec',
    de: 'Mit der aktiven Farbe verbunden mit',
    pt: 'Conectado à cor ativa com',
    cs: 'Spojeno s aktivní barvou pomocí',
    fi: 'Yhdistetty aktiiviseen väriin tasolla',
  },
  ContrastAt: {
    en: 'contrast at',
    es: 'contraste de',
  ...
  NoActiveContrastConnectionAnnounced: {
    en: 'No active contrast connection announced.',
    es: 'No se anuncia ninguna conexión de contraste activa.',
    fr: 'Aucune connexion de contraste active n est annoncée.',
    de: 'Es wird keine aktive Kontrastverbindung angesagt.',
    pt: 'Nenhuma conexão de contraste ativa é anunciada.',
    cs: 'Není hlášeno žádné aktivní kontrastní spojení.',
    fi: 'Aktiivista kontrastiyhteyttä ei ilmoiteta.',
  },
  ShowColorLinksAtContrastAndAbove: {
    en: 'Show color links at contrast and above',
    es: 'Mostrar vínculos de color con contraste y superior',
    fr: 'Afficher les liens de couleur à ce contraste et au-dessus',
    de: 'Farblinks mit diesem Kontrast und höher anzeigen',
    pt: 'Mostrar ligações de cores com este contraste e acima',
    cs: 'Zobrazit barevná propojení s tímto kontrastem a vyšším',
    fi: 'Näytä väriyhteydet tällä kontrastilla ja sitä suuremmilla arvoilla',
  },
  BelowThreshold: {
    en: 'below threshold',
    es: 'por debajo del umbral',
    fr: 'sous le seuil',
    de: 'unter dem Schwellenwert',
    pt: 'abaixo do limite',
    cs: 'pod prahem',
    fi: 'kynnyksen alapuolella',
  },
  ColorConstellationInstructions: {
    en: 'This is a draggable color constellation. Tab to a color, use arrow keys to move it, press Enter or Space to pin it, and press Escape to clear the current selection. The live status announces visible contrast matches at the selected threshold.',
    es: 'Esta es una constelación de colores arrastrable. Use Tab para ir a un color, use las teclas de flecha para moverlo, presione Enter o Espacio para fijarlo y presione Escape para borrar la selección actual. El estado en vivo anuncia las coincidencias de contraste visibles en el umbral seleccionado.',
    fr: 'Il s agit d une constellation de couleurs déplaçable. Utilisez Tab pour atteindre une couleur, les touches fléchées pour la déplacer, Entrée ou Espace pour l épingler, et Échap pour effacer la sélection actuelle. Le statut en direct annonce les correspondances de contraste visibles au seuil sélectionné.',
    de: 'Dies ist eine verschiebbare Farbkonstellation. Wechseln Sie mit Tab zu einer Farbe, bewegen Sie sie mit den Pfeiltasten, drücken Sie Enter oder Leertaste zum Fixieren und Escape, um die aktuelle Auswahl zu löschen. Die Live-Statusmeldung kündigt sichtbare Kontrasttreffer beim gewählten Schwellenwert an.',
    pt: 'Esta é uma constelação de cores arrastável. Use Tab para ir até uma cor, use as teclas de seta para movê-la, pressione Enter ou Espaço para fixá-la e pressione Escape para limpar a seleção atual. O estado ao vivo anuncia as correspondências de contraste visíveis no limite selecionado.',
    cs: 'Toto je přetahovatelná barevná konstelace. Pomocí klávesy Tab přejděte na barvu, šipkami ji posuňte, klávesou Enter nebo mezerníkem ji připněte a klávesou Escape vymažte aktuální výběr. Živý stav oznamuje viditelné kontrastní shody při zvoleném prahu.',
    fi: 'Tämä on siirrettävä värikonstellaatio. Siirry väriin sarkaimella, liikuta sitä nuolinäppäimillä, kiinnitä se Enterillä tai välilyönnillä ja tyhjennä nykyinen valinta Escapella. Live-tila ilmoittaa valitun kynnyksen näkyvät kontrastiosumat.',
  },
  SelectColorFormat: {
  ...
  CloneABlobByClickingTheBottomRightCopySign: {
    en: 'Clone a blob by clicking the bottom right copy sign and then the blob',
    es: 'Clona un blob haciendo clic en el signo de copia en la esquina inferior derecha y luego en el blob',
    fr: 'Cloner un blob en cliquant sur le signe de copie en bas à droite, puis sur le blob',
    de: 'Klonen Sie einen Blob, indem Sie auf das Kopiersymbol unten rechts und dann auf den Blob klicken',
    pt: 'Clone um blob clicando no ícone de cópia no canto inferior direito e depois no blob',
    cs: 'Klonujte blob kliknutím na kopírovací symbol v pravém dolním rohu a poté na blob',
    fi: 'Kloonaa mollukka klikkaamalla oikean alakulman kopiosymbolia ja sitten mollukkaa',
  },
  ...
  ResetCanvas: {
    en: 'Reset canvas',
    es: 'Restablecer lienzo',
    fr: 'Réinitialiser la toile',
  ...
  MoreColorsAvailableThroughRandomBlobButton: {
    en: 'More colors are available through the random blob button: the plus sign at the bottom middle of the screen',
    es: 'Más colores están disponibles a través del botón de blob aleatorio: el signo más en la parte inferior del centro de la pantalla',
    fr: 'Plus de couleurs sont disponibles via le bouton de blob aléatoire: le signe plus en bas au milieu de l écran',
    de: 'Mehr Farben sind über die zufällige Blob-Schaltfläche verfügbar: das Pluszeichen in der Mitte unten auf dem Bildschirm',
    pt: 'Mais cores estão disponíveis através do botão de blob aleatório: o sinal de mais na parte inferior do meio da tela',
    cs: 'Další barvy jsou k dispozici pomocí tlačítka náhodného blobu: plusový znak ve spodní části obrazovky',
    fi: 'Lisää värejä on saatavilla satunnaisen mollukan painikkeen kautta: plussamerkki näytön alaosassa keskellä',
  },
  ...
  MediaWithQuotesOrPoems: {
    en: 'Media with random quotes or poems',
    es: 'Medios con citas o poemas aleatorios',
    fr: 'Médias avec des citations ou des poèmes aléatoires',
    de: 'Medien mit zufälligen Zitaten oder Gedichten',
    pt: 'Mídia com citações ou poemas aleatórios',
    cs: 'Média s náhodnými citáty nebo básněmi',
    fi: 'Mediaa sattumanvaraisilla lainauksilla tai runoilla',
  },
  TextType: {
    en: 'Text type',
    es: 'Tipo de texto',
  ...
  FrontPageOrExit: {
    en: 'Front Page / exit',
    es: 'Página principal / salir',
    fr: "Page d'accueil / sortie",
    de: 'Startseite / Ausgang',
    pt: 'Página inicial / sair',
  ...
  AlreadyOnSelectedPage: {
    en: 'Already on the selected page',
    es: 'Ya estás en la página seleccionada',
    fr: 'Déjà sur la page sélectionnée',
    de: 'Bereits auf der ausgewählten Seite',
  ...
  UnavailableForTestUser: {
    ...
    es: 'No disponible para la cuenta de usuario de prueba',
    fr: 'Indisponible pour le compte utilisateur de test',
    de: 'Für das Testbenutzerkonto nicht verfügbar',
    pt: 'Indisponível para a conta de usuário de teste',
    cs: 'Není k dispozici pro testovací uživatelský účet',
    fi: 'Ei saatavilla testikäyttäjätilille',
  },
  AlreadySelected: {
    en: 'Already selected',
    es: 'Ya seleccionado',
  ...
  NoCompletedTasks: {
    ...
    es: 'No hay tareas completadas disponibles',
    fr: 'Aucune tâche terminée disponible',
    de: 'Keine abgeschlossenen Aufgaben verfügbar',
    pt: 'Nenhuma tarefa concluída disponível',
    cs: 'Nejsou k dispozici žádné dokončené úkoly',
    fi: 'Valmiita tehtäviä ei ole saatavilla',
  },
  NoTasksToReorder: {
    en: 'No tasks available to reorder',
    es: 'No hay tareas disponibles para reordenar',
    fr: 'Aucune tâche disponible à réorganiser',
    de: 'Keine Aufgaben zum Neuordnen verfügbar',
    pt: 'Nenhuma tarefa disponível para reordenar',
    cs: 'Nejsou k dispozici žádné úkoly k přeřazení',
    fi: 'Järjesteltäviä tehtäviä ei ole saatavilla',
  },
  AlreadyAtTop: {
    en: 'Already at the top',
    es: 'Ya está arriba',
    fr: 'Déjà en haut',
    de: 'Bereits ganz oben',
    pt: 'Já está no topo',
    cs: 'Již je nahoře',
    fi: 'On jo ylhäällä',
  },
  AlreadyAtBottom: {
    ...
    es: 'Ya está abajo',
    fr: 'Déjà en bas',
    de: 'Bereits ganz unten',
    pt: 'Já está em baixo',
    cs: 'Již je dole',
    fi: 'On jo alhaalla',
  },
  CompletedTasksCannotBeEdited: {
    en: 'Completed tasks cannot be edited',
    es: 'Las tareas completadas no se pueden editar',
    fr: 'Les tâches terminées ne peuvent pas être modifiées',
    de: 'Abgeschlossene Aufgaben können nicht bearbeitet werden',
    pt: 'Tarefas concluídas não podem ser editadas',
    cs: 'Dokončené úkoly nelze upravovat',
    fi: 'Valmiita tehtäviä ei voi muokata',
  },
  QuestionAlreadyAnswered: {
    en: 'This question has already been answered',
    es: 'Esta pregunta ya fue respondida',
    fr: 'Cette question a déjà reçu une réponse',
    de: 'Diese Frage wurde bereits beantwortet',
    pt: 'Esta pergunta já foi respondida',
    cs: 'Na tuto otázku již bylo odpovězeno',
    fi: 'Tähän kysymykseen on jo vastattu',
  },
  GetInTouch: {
    en: 'Get in touch',
  ...
  ResizeCanvas: {
    en: 'Resize canvas',
    es: 'Redimensionar lienzo',
    fr: 'Redimensionner la zone',
    de: 'Zeichenfläche skalieren',
    pt: 'Redimensionar a tela',
    cs: 'Změnit velikost plochy',
    fi: 'Muuta piirtoalueen kokoa',
  },
  ResizeCanvasInstructions: {
    en: 'Drag to resize the canvas. Keyboard use: use the arrow keys to resize, and Shift plus arrow keys for larger steps.',
    es: 'Arrastre para cambiar el tamaño del lienzo. Uso del teclado: use las teclas de flecha para cambiar el tamaño y Mayús más flechas para pasos más grandes.',
    fr: 'Faites glisser pour redimensionner la zone. Utilisation au clavier : utilisez les touches fléchées pour redimensionner et Maj plus les flèches pour des pas plus grands.',
    de: 'Zum Ändern der Größe ziehen. Tastatur: Verwenden Sie die Pfeiltasten zum Ändern der Größe und Umschalt plus Pfeiltasten für größere Schritte.',
