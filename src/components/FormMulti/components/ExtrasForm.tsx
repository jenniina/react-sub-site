...
export function ExtrasForm({
    ...
    useEffect(() => {
        updateFields({
            selectmulti: values?.map((element) => {
        ...
        <>
            <FormWrapper title='Additional information'
                ...
                <div className={styles.subfield}>
                    ...
                    <label className='full left' htmlFor='form-encouragement'>Any encouraging words?</label>
                    <textarea id='form-encouragement'
                        className='full'
                        autoFocus
                        name='encouragement'
                        value={encouragement}
                ...
                <div className={styles.subfield}>
                    <label id='label-color' className={`left nowrap full ${styles.colorlabel}`}>A Color You Like?</label>
                ...
                <div className={styles.subfield}>
                    ...
                    <label htmlFor='form-dark'
                        ...
                        <input id='form-dark'
                            ...
                            value={'dark mode'}
                            onChange={e =>
                                updateFields({ dark: e.target.value })}
                        /> Dark Mode
                    </label>
                    <label htmlFor='form-light'
                        className='nowrap'>
                        <input id='form-light'
                            type='radio'
                            name='mode'
                ...
                <div>
                    <label className='radio-checkbox' htmlFor='form-gdpr'><input id='form-gdpr'
                        required
                        type='checkbox'
                        name='gdpr'
                        value={'gdpr-ok'}
                    ...
                    /><i className='required' aria-hidden='true' >*</i> It is alright to send the entered information to Jenniina </label>
                </div>
            </FormWrapper>
        </>
