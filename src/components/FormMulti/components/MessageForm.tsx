...
export function MessageForm({
    ...
    const [selectsingle, setSelect] = useLocalStorage<SelectOption | undefined>("selectsingle", options[0])
    ...
    return (
        <FormWrapper title='Message' description="Please send me a few words, and I'll respond as soon as I can.">
            <div className={styles.subfield} style={{ paddingTop: '4em' }}>
                <div className='input-wrap'>
                    ...
                    <label htmlFor='form-email'>
                        ...
                        /><span>Your Email <i className='required' aria-hidden='true' >*</i></span></label>
                </div>
            </div>
            ...
            <div className={styles.subfield}>
                <label htmlFor='form-message'>Message <i className='required' aria-hidden='true' >*</i></label>
